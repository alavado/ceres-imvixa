      ...
      <div id="tabla-impacto-productivo">
        <div className="columna-impacto-productivo">
          ...
          <div className="indicadores-impacto-productivo">
            {objetivos.includes(OBJETIVO_PESO) && objetivos.includes(OBJETIVO_FECHA) ?
              <>
                <h2>{redondearString(curvaTradicional.length / 30.0)}</h2>
                <p>meses ciclo</p>
                <h2>{redondearString(curvaTradicional[curvaTradicional.length - 1] / 1000.0, 2)}</h2>
                <p>kg a la cosecha</p>
                <h2>{redondearString(biomasaTradicional / 1000, 0)}</h2>
                <p>toneladas cosechadas</p>
              </> :
              objetivos.includes(OBJETIVO_PESO) ?
              <>
                <h2>{redondearString(curvaImvixa.length / 30.0)}</h2>
                <p>meses ciclo</p>
                <h2>{redondearString(biomasaImvixa / 1000, 0)}</h2>
                <p>toneladas cosechadas</p>
              </> :
              <>
                <h2>{redondearString(curvaTradicional[curvaTradicional.length - 1] / 1000.0, 2)}</h2>
          ...
          <div className="indicadores-impacto-productivo">
            {objetivos.includes(OBJETIVO_PESO) && objetivos.includes(OBJETIVO_FECHA)?
              <>
                <h2>{redondearString(curvaImvixa.length / 30.0)}</h2>
                <p>meses ciclo</p>
                <h2>{redondearString(curvaImvixa[curvaImvixa.length - 1] / 1000.0, 2)}</h2>
                <p>kg a la cosecha</p>
                <h2>{redondearString(biomasaImvixa / 1000, 0)}</h2>
                <p>toneladas cosechadas</p>
              </> :
        ...
        <div className="columna-impacto-productivo">
          ...
          <div className="indicadores-impacto-productivo">
            {objetivos.includes(OBJETIVO_PESO) && objetivos.includes(OBJETIVO_FECHA)?
              <>
                <h2>{redondearString(-curvaTradicional.length / 30.0 + curvaImvixa.length / 30.0)}</h2>
                <p>meses</p>
                <h2>{redondearString(-curvaTradicional[curvaImvixa.length - 1] / 1000.0 + curvaImvixa[curvaImvixa.length - 1] / 1000.0, 2)}</h2>
                <p>kg a {redondearString(curvaImvixa.length / 30.0)} meses</p>
                <h2>{redondearString(-biomasaTradicional / 1000 + biomasaImvixa / 1000, 0)}</h2>
                <p>toneladas cosechadas</p>
              </> :
              objetivos.includes(OBJETIVO_PESO) ?
              <>
