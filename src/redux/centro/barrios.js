...
const macrozonas = {
  ...
  "9": ["41","42", "43 A", "43 B", "44", "45", "46", "47 A", "47 B", "48"],
  "10": ["49 A", "49 B","50 A", "50 B", "51", "52", "53", "54 A", "54 B", "55", "56", "57", "58", "59", "60", "61", "62"]
}
...
const barrios = [
  ...
  "41","42", "43 A", "43 B", "44", "45", "46", "47 A", "47 B", "48", 
  "49 A", "49 B", "50 A", "50 B", "51", "52", "53", "54 A", "54 B", "55", "56", "57", "58", "59", "60", "61", "62"
]
...
const posicionesBarrios = {
  ...
  // los que siguen los saque de los poligonos de barrios
  "41": { lat: -51.163, lng: -73.778},
  "42": { lat: -51.452, lng: -73.734},
  "43 A": { lat: -51.842, lng: -73.554},
  "43 B": { lat: -51.983, lng: -73.413},
  "44": { lat: -51.564, lng: -72.964},
  "45": { lat: -51.755, lng: -72.903},
  "46": { lat: -52.021, lng: -72.612},
  "47 A": { lat: -52.218, lng: -72.828},
  "47 B": { lat: -52.078, lng: -72.810},
  "48": { lat: -52.146, lng: -73.013},
  "49 A": { lat: -52.557, lng: -71.916},
  "49 B": { lat: -52.701, lng: -71.838},
  "50 A": { lat: -52.661, lng: -72.370},
  "50 B": { lat: -52.765, lng: -72.511},
  "51": { lat: -52.847, lng: -73.444},
  "52": { lat: -53.193, lng: -73.540},
  "53": { lat: -53.119, lng: -72.899},
  "54 A": { lat: -53.957, lng: -71.517},
  "54 B": { lat: -54.032, lng: -71.407},
  "55": { lat: -54.133, lng: -71.160},
  "56": { lat: -54.032, lng: -71.407},
  "57": { lat: -54.489, lng: -71.763},
  "58": { lat: -54.443, lng: -71.622},
  "59": { lat: -54.408, lng: -71.455},
  "60": { lat: -54.425, lng: -71.226},
  "61": { lat: -54.928, lng: -67.363},
  "62": { lat:-55.006, lng: -67.140}
}
...
// Faltaria un modelo de mortalidad
const modelosMortalidadMacrozonas = {
  ...
  "9": {"coefs": [0.0, 3.077962893732444e-05, 1.330732801920674e-07], "intercepto": 0.0052083643490512775},
  "10": {"coefs": [0.0, 3.077962893732444e-05, 1.330732801920674e-07], "intercepto": 0.0052083643490512775},
}
// Para obtener barrios primero filtro aquellos que tienen centros
// Luego por cada uno de ellos utilizo el nombre dado por el array barrios
// Y obtengo las posiciones, macrozona, modelo de mortalidad y centros relacionados
const obtenerBarrios = (centros = centrosFormateados) => barrios.filter(nombre => centros.filter(centro => centro.barrio === nombre.replace(' ', '')).length > 0).map(nombre => {
  ...
  return {
    ...
    modeloMortalidad,
    centros: centros.filter(centro => centro.barrio === nombre.replace(' ', ''))
  }
})

export default obtenerBarrios